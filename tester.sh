...
group2=("http://localhost:9222/segments" "http://localhost:9222/mysql" "http://localhost:9222/roundtripper" "http://localhost:9222/custommetric" "http://localhost:9222/browser" "http://localhost:9222/async" "http://localhost:9222/message" "http://localhost:9222/log" "http://localhost:9222/external")
